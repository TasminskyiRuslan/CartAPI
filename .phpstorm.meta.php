...
'boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains','data.date_format','data.date_timezone',
...
'sanctum.csrf-cookie','auth.me','auth.register','auth.login','storage.local',);
...
'AUTH_GUARD','L5_SWAGGER_GENERATE_ALWAYS',);
