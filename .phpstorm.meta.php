...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'cart.guest_header' => 'string',
            'cart.expiration_days.guest' => 'integer',
            'cart.expiration_days.user' => 'integer',
            'cart.max_quantity' => 'integer',
...
'cart.guest_header','cart.expiration_days.guest','cart.expiration_days.user','cart.max_quantity','database.default',
...
'boost.browser_logs_watcher','mcp.redirect_domains','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables',
