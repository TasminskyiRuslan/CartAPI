...
'cart.cart_guest_header','database.default','database.connections.sqlite.driver','database.connections.sqlite.url','database.connections.sqlite.database',
...
'filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api',
...
'session.partitioned','boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains','data.date_format',
...
'MYSQL_ROOT_PASSWORD','MYSQL_DATABASE','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
...
'AUTH_GUARD','L5_SWAGGER_GENERATE_ALWAYS','CART_GUEST_HEADER',);
